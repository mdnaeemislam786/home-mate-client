...
const HomeSlider = () => {
    ...
    //         description: "Get connected with providers in minutes, not days"
    //     },
    //     {
    //         icon: <Star className="w-8 h-8" />,
    //         title: "Rated & Reviewed",
    //         description: "Read real reviews from thousands of satisfied customers"
    //     },
    //     {
    //         icon: <Users className="w-8 h-8" />,
    //         title: "Trusted Community",
    //         description: "Join 50,000+ homeowners who trust our platform"
    //     }
    // ];
